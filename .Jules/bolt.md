...
## 2026-08-01 - Optimize High-Frequency Logging
**Learning:** String templates are eagerly evaluated. Using them inside high-frequency loops or logging statements causes continuous string allocation and GC thrashing.
