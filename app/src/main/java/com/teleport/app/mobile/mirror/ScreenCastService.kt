        ...
        while (isRunning) {
            ...
            if (outputBufferIndex >= 0) {
                ...
                if (outputBuffer != null && bufferInfo.size > 0) {
                    ...
                    // Bolt: Avoid continuous ByteArray allocations in high-frequency video encoding loop.
                    // Convert directly from ByteBuffer to Okio's ByteString to reduce GC pressure and CPU copying overhead.
