                            ...
                            try {
                                for (frame in incoming) {
                                    if (frame is Frame.Binary) {
                                        // Bolt: Use frame.data directly instead of frame.readBytes() to avoid redundant array allocations in this high-frequency streaming path, lowering GC pressure.
                                        val data = frame.data
